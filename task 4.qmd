...
mcnemar.test for count data for pre and post ibis
table admit_count, pre, post

```{r}
# Create 2x2 table for pre and post IBIS inpatient admissions
table_admit <- table(report_full$pre_ibis_inpatient, report_full$post_ibis_inpatient)
